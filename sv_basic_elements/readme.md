# Синтез типових елементів цифрових систем за допомогою HDL-мови System Verilog
...
2. Кілька виходів: кількість виходів зазвичай визначається як $2^n$ , де $n$ — це кількість керуючих сигналів.
...
[cod_4to2_simple.sv](src_code/cod_4to2_simple.sv)

[cod_4to2_simple_zrf.sv](src_code/cod_4to2_simple_zrf.sv)

[cod_4to2_simple_zrf_oer.sv](src_code/cod_4to2_simple_zrf_oer.sv)

[cod_4to2_priority.sv](src_code/cod_4to2_priority.sv)
